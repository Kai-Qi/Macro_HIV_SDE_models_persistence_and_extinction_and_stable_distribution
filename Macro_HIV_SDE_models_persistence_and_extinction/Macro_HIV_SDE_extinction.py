...
def Marco_hiv_sde():
    Pi = 10000
    k = 0.8
    beta1 = 0.007*pow(10,-5) 
    beta2 = 0.005*pow(10,-5) 
    beta3 = 0.004*pow(10,-5) 
    beta4 = 0.006*pow(10,-5) 
    mu = 0.025; sigma = 0.2 ; rho1 = 0.1; gamma1 = 0.3; rho2 = 0.09
    psi = 0.4; 
    rho3 = 0.4; gamma2 = 0.15; rho4 = 0.1; gamma3 = 0.3
    delta1 = 0.33; delta2 = 0.2
    sigma_1 = 0.000004** 0.5; sigma_2 = 0.0001** 0.5; sigma_3 = 0.0001** 0.5; sigma_4 = 0.0001** 0.5 
    sigma_5 = 0.001** 0.5; sigma_6 = 0.0001** 0.5; sigma_7 = 0.0001** 0.5
    dt = np.array([0.01 ])
    ...
    plt.subplot(232)
    plt.plot(I); plt.plot(I_ode); plt.xlabel("  I and I_ode"); plt.xlim(0, 8000)

    plt.subplot(233)
    plt.plot(C); plt.plot(C_ode); plt.xlabel("C and C_ode"); plt.xlim(0, 8000)

    plt.subplot(234)
    plt.plot(C_s); plt.plot(C_s_ode); plt.xlabel("C_s and C_s_ode"); plt.xlim(0, 8000)

    plt.subplot(235)
    plt.plot(T); plt.plot(T_ode); plt.xlabel("T and T_ode"); plt.xlim(0, 8000)

    plt.subplot(236)
    plt.plot(A); plt.plot(A_ode); plt.xlabel("A and A_ode"); plt.xlim(0, 8000)
